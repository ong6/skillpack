...
Local changes: renamed skill to build-blender-scene, narrowed its trigger to Blender-selected work,
and connected it to the shared design-3d decision and animation review. No upstream scripts
